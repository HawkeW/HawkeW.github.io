...
![image-20221107170223156](./01.png)

2. 填入"仓库名称"后，点击创建按钮

![image-20221107170320517](./02.png)

3. 创建成功

![image-20221107170340215](./03.png)
...
![image-20221109114333697](./04.png)
...
![image-20221109114433426](./05.png)
...
![image-20221109124628016](./06.png)
...
![image-20221109124816009](./07.png)
...
![image-20221109125530251](./08.png)

添加完成后，可以使用`git status`查看状态，可以看到文件已经变"绿"了，即暂存成功了：

![image-20221109125607323](./09.png)
...
![image-20221109130117052](./10.png)

当把所有修改提交完毕后，`git status`再次查看，可以看到已经没有变更内容了

![image-20221109130133992](./11.png)
